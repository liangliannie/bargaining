...
# print(np.array(p1))
# plt.plot(range(20), share, '.-', linewidth=.3, alpha=0.3)
# plt.plot(range(20), share.mean(axis=1), '*-', label='Average', linewidth=3, markersize=12)
...
# for i in range(20):
#     ymax = share[i].max()
#     plt.annotate(str(i), xy=(i, ymax), xytext=(i, ymax+.005), arrowprops=dict(facecolor='black', shrink=0.0005, width=0.03, headwidth=0.003, headlength=0.003))
